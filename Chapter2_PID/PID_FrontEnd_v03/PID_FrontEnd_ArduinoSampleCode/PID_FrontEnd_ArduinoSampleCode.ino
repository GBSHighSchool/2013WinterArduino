...
void setup()
{
  Input = analogRead(inputPin); // Read in light level
  Setpoint = analogRead(pot); // Read the SetPoint value from the potentiometer
...
void loop(){
  Input = analogRead(inputPin); // Read in light level
  Setpoint = analogRead(pot); // Read our setpoint light Level from the potentiometer 
